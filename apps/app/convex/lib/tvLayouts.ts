...
export const PANEL_V2_LAYOUT = [
  { kind: "banner", x: 1, y: 1, w: 20, h: 9, z: 1, text: "logo" },
  { kind: "clock", x: 22, y: 1, w: 77, h: 9, z: 1, text: "event", fontSize: 1.5 },
  { kind: "liveCommitPulse", x: 1, y: 11, w: 64, h: 8, z: 1, text: "" },
  { kind: "liveTokens", x: 1, y: 20, w: 64, h: 18, z: 1, text: "" },
  { kind: "liveLeaderboard", x: 1, y: 39, w: 31, h: 51, z: 1, text: "" },
  { kind: "liveAgents", x: 33, y: 39, w: 32, h: 25, z: 1, text: "" },
  { kind: "liveModels", x: 33, y: 65, w: 32, h: 25, z: 1, text: "" },
  {
    kind: "feed",
    x: 66,
    y: 11,
