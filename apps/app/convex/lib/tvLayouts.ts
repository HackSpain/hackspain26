...
export const PANEL_V2_LAYOUT = [
  ...
  { kind: "clock", x: 52, y: 1, w: 46, h: 11, z: 1, text: "event", fontSize: 1.5 },
  { kind: "liveTokens", x: 2, y: 14, w: 30, h: 20, z: 1, text: "" },
  { kind: "liveAgents", x: 34, y: 14, w: 32, h: 36, z: 1, text: "" },
  {
    kind: "feed",
    x: 68,
    y: 14,
  ...
  { kind: "liveCommits", x: 34, y: 52, w: 32, h: 37, z: 1, text: "" },
  { kind: "sponsorTicker", x: 0, y: 91, w: 100, h: 9, z: 1, text: "" },
] satisfies LayoutWidget[];
