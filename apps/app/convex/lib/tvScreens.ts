...
export const screenPresetValidator = v.union(
  ...
  v.literal("patrocinadores"),   v.literal("espera"), v.literal("panel"), v.literal("panelv2"), v.literal("equipos"),
  v.literal("mentores"),
);
...
export const SCREEN_PRESETS: { value: ScreenPreset; label: string; description: string }[] = [
  ...
  { value: "mentores", label: "Mentores", description: "Quiénes están ahora en sala" },
];
