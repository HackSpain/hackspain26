...
brand glyph elsewhere: ✻ Claude Code, ⬡ Codex, ✦ Gemini CLI, ❋ Qwen Code, ▍ Cursor, ◆ OpenCode, ⬢ Kilo Code, ▣ Cline, ◉ Copilot, π Pi, π Oh My Pi;
...
AI coding harnesses it finds (Claude Code, Codex, Gemini CLI, Qwen Code, OpenCode, Kilo Code, Cline, Pi, Oh My Pi), normalises them into one
