...
brand glyph elsewhere: ✻ Claude Code, ⬡ Codex, ✦ Gemini CLI, ❋ Qwen Code, ▍ Cursor, ◆ OpenCode, ▣ Cline, ◉ Copilot;
...
AI coding harnesses it finds (Claude Code, Codex, Gemini CLI, Qwen Code, OpenCode, Cline), normalises them into one
