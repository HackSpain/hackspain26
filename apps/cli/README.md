...
brand glyph elsewhere: ✻ Claude Code, ⬡ Codex, ✦ Gemini CLI, ❋ Qwen Code, ▍ Cursor, ◆ OpenCode, ⬢ Kilo Code, ▣ Cline, ◭ Roo Code, ◉ Copilot;
...
AI coding harnesses it finds (Claude Code, Codex, Gemini CLI, Qwen Code, OpenCode, Kilo Code, Cline, Roo Code), normalises them into one
