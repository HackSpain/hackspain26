...
desktop designs. A server-generated sponsor seed keeps the randomized first
order stable through hydration; later pinned sections reshuffle on navigation.
A local raw-HTML
